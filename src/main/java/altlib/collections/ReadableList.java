...
public interface ReadableList<T> {
    ...
    /**
     * Executes the specified function for each element of the current list and generates a new list, with the same type as the current list, containing the results of the execution of the function.
